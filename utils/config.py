...
- Что это была за тренировка (тип, название, когда, где)
- Основные показатели (дистанция, время, темп/скорость)
- Пульс и зоны интенсивности
- Высота и рельеф (если есть)
- Тренировочный эффект и нагрузка
- Что получилось хорошо, на что обратить внимание

Если есть сплиты или круги — кратко упомяни динамику.
Если есть данные о каденсе, шаге, мощности — включи их в анализ.
...
и предложи 2–3 вопроса про тренировку, восстановление или следующие шаги.
"""
